...
class LabelEncoder(base.BaseEstimator):
    ...
    Source: https://github.com/jeongyoonlee/Kaggler/blob/master/kaggler/preprocessing/data.py
    Attributes:
    ...
    def fit_transform(self, X, y=None):
        ...
        for i, col in enumerate(X.columns):
            ...
            X.loc[:, col] = X[col].fillna(NAN_INT).map(
                self.label_encoders[i]).fillna(0)
